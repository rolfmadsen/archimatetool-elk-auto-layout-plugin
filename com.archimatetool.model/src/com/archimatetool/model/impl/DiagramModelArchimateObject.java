...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diagram Model Archimate
 * Object</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * </p>
 * <ul>
 * <li>{@link com.archimatetool.model.impl.DiagramModelArchimateObject#getChildren
 * <em>Children</em>}</li>
 * <li>{@link com.archimatetool.model.impl.DiagramModelArchimateObject#getTextPosition
 * <em>Text Position</em>}</li>
 * <li>{@link com.archimatetool.model.impl.DiagramModelArchimateObject#getImagePath
 * <em>Image Path</em>}</li>
 * <li>{@link com.archimatetool.model.impl.DiagramModelArchimateObject#getImagePosition
 * <em>Image Position</em>}</li>
 * <li>{@link com.archimatetool.model.impl.DiagramModelArchimateObject#getArchimateElement
 * <em>Archimate Element</em>}</li>
 * <li>{@link com.archimatetool.model.impl.DiagramModelArchimateObject#getType
 * <em>Type</em>}</li>
 * </ul>
 *
 * @generated
...
public class DiagramModelArchimateObject extends DiagramModelObject implements IDiagramModelArchimateObject {
    ...
    /**
     * The default value of the '{@link #getTextPosition() <em>Text Position</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getTextPosition() <em>Text Position</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The default value of the '{@link #getImagePosition() <em>Image
    ...
    /**
     * The cached value of the '{@link #getImagePosition() <em>Image Position</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public EList<IDiagramModelObject> getChildren() {
        if (children == null) {
            children = new EObjectContainmentEList<IDiagramModelObject>(IDiagramModelObject.class, this,
                    IArchimatePackage.DIAGRAM_MODEL_ARCHIMATE_OBJECT__CHILDREN);
        }
        return children;
    }
    ...
    public void setTextPosition(int newTextPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    IArchimatePackage.DIAGRAM_MODEL_ARCHIMATE_OBJECT__TEXT_POSITION, oldTextPosition, textPosition));
    }
    ...
    public void setImagePath(String newImagePath) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    IArchimatePackage.DIAGRAM_MODEL_ARCHIMATE_OBJECT__IMAGE_PATH, oldImagePath, imagePath));
    }
    ...
    public void setImagePosition(int newImagePosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    IArchimatePackage.DIAGRAM_MODEL_ARCHIMATE_OBJECT__IMAGE_POSITION, oldImagePosition, imagePosition));
    }
    ...
    public void setArchimateElement(IArchimateElement archimateElement) {
        // If we already have an element we *must* remove it from the referenced list
        // first
    ...
    public void setType(int newType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    IArchimatePackage.DIAGRAM_MODEL_ARCHIMATE_OBJECT__TYPE, oldType, type));
    }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == IDiagramModelContainer.class) {
            switch (derivedFeatureID) {
                case IArchimatePackage.DIAGRAM_MODEL_ARCHIMATE_OBJECT__CHILDREN:
                    return IArchimatePackage.DIAGRAM_MODEL_CONTAINER__CHILDREN;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == ITextPosition.class) {
            switch (derivedFeatureID) {
                case IArchimatePackage.DIAGRAM_MODEL_ARCHIMATE_OBJECT__TEXT_POSITION:
                    return IArchimatePackage.TEXT_POSITION__TEXT_POSITION;
                default:
                    return -1;
            }
        }
        if (baseClass == IDiagramModelImageProvider.class) {
            switch (derivedFeatureID) {
                case IArchimatePackage.DIAGRAM_MODEL_ARCHIMATE_OBJECT__IMAGE_PATH:
                    return IArchimatePackage.DIAGRAM_MODEL_IMAGE_PROVIDER__IMAGE_PATH;
                default:
                    return -1;
            }
        }
        if (baseClass == IIconic.class) {
            switch (derivedFeatureID) {
                case IArchimatePackage.DIAGRAM_MODEL_ARCHIMATE_OBJECT__IMAGE_POSITION:
                    return IArchimatePackage.ICONIC__IMAGE_POSITION;
                default:
                    return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == IDiagramModelContainer.class) {
            switch (baseFeatureID) {
                case IArchimatePackage.DIAGRAM_MODEL_CONTAINER__CHILDREN:
                    return IArchimatePackage.DIAGRAM_MODEL_ARCHIMATE_OBJECT__CHILDREN;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == ITextPosition.class) {
            switch (baseFeatureID) {
                case IArchimatePackage.TEXT_POSITION__TEXT_POSITION:
                    return IArchimatePackage.DIAGRAM_MODEL_ARCHIMATE_OBJECT__TEXT_POSITION;
                default:
                    return -1;
            }
        }
        if (baseClass == IDiagramModelImageProvider.class) {
            switch (baseFeatureID) {
                case IArchimatePackage.DIAGRAM_MODEL_IMAGE_PROVIDER__IMAGE_PATH:
                    return IArchimatePackage.DIAGRAM_MODEL_ARCHIMATE_OBJECT__IMAGE_PATH;
                default:
                    return -1;
            }
        }
        if (baseClass == IIconic.class) {
            switch (baseFeatureID) {
                case IArchimatePackage.ICONIC__IMAGE_POSITION:
                    return IArchimatePackage.DIAGRAM_MODEL_ARCHIMATE_OBJECT__IMAGE_POSITION;
                default:
                    return -1;
            }
        }
